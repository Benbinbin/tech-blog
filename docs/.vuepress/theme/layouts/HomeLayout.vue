  ...
  <div class="min-h-screen w-full flex flex-col bg-gray-100">
    ...
    >
      ...
      <Content
        ...
        class="text-gray-300 text-lg font-light"
      />
    </div>
    ...
    <div
      class="cards-container grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-5 px-20 md:px-10 my-10"
    >
      <div
        v-for="card of cards"
        :key="card.name"
      ...
      >
        <a :href="`/${card.name}/index.html`" class="absolute inset-0 z-20"></a>
