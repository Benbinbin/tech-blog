<template>
  <div class="min-h-screen flex flex-col">
    ...
    <main class="flex-grow">
      ...
      <div class="container p-10 mx-auto flex flex-col sm:flex-row space-y-2 sm:space-y-0 sm:justify-between">
    ...
    const data = reactive({
      ...
      setFolderHandler(value) {
        ...
        if (folderNameArr.length > 1) {
          const searchStr = `?folder=${folderNameArr
            .slice(1)
            .join("&folder=")}`;
