...
![新建仓库](./_v_images/20191121231306446_13742.png)
...
```
![克隆仓库](./_v_images/20191123115144238_16955.png)

![course_git_blog_poject](./_v_images/20191123120142305_5017.png)
...
![克隆仓库状态](./_v_images/20191123163009784_14633.png)
...
![新建仓库状态](./_v_images/20191123165430232_5740.png)
...
### 命令 `git log`
![git log](./_v_images/20191123200309211_1022.png)
...
![新建文件后查看 git status](./_v_images/20191124102942971_15126.png)

新建三个文件后使用命令 `git status` 输出提示为 `Untracked files` 包含这三个文件，即 git 还没有跟踪这些文件。

![暂存 html 文件](./_v_images/20191124103620980_30568.png)
...
![在代码编辑器 VS Code 中输入 commit 消息](./_v_images/20191124125623360_3929.png)
...
![提交后终端输出 commit 信息](./_v_images/20191124133550964_11673.png)
...
![重置 commit](./_v_images/20191125232007335_276.png)
...
![重置 commit 且更改移至工作区](./_v_images/20191125233006182_14015.png)
...
![查看文件具体更改](./_v_images/20191124145801921_27239.png)
...
![忽略文件](./_v_images/20191124155044992_28293.png)
...
![添加标签](./_v_images/20191124170114997_8118.png)
...
![多种方法查询标签](./_v_images/20191124174723785_10228.png)

### 删除标签
使用命令 `git tag -d <tag_name>`（选项 `-d` 表示 delete 删除）删除指定的 git 标签 `<tag_name>`

![删除标签](./_v_images/20191124174948372_32376.png)
...
![活跃分支](./_v_images/20191124214539558_9509.png)

使用命令 `git log` 或 `git log --decorate` 查看日志时也会显示分支，其中 `HEAD` 指向的是当前分支

![日志中的分支](./_v_images/20191124215936614_2725.png)
...
![快进合并](./_v_images/20191125093413365_22843.png)
...
![普通合并](./_v_images/20191125094019574_16234.png)
...
![合并冲突](./_v_images/20191125160452047_12583.png)
...
![合并冲突指示符](./_v_images/20191125160732615_14810.png)
...
![处理冲突](./_v_images/20191125161309425_29506.gif)
